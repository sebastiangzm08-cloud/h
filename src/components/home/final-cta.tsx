    ...
    <section className="bg-paper">
      <div className="mx-auto max-w-7xl px-5 py-28 sm:px-8 sm:py-36">
        <Reveal className="mx-auto max-w-2xl text-center">
          <h2 className="text-[2.25rem] leading-[1.05] font-semibold tracking-tight text-ink sm:text-[3rem]">
            Empecemos por los tres procesos que más te cuestan
          </h2>
          <p className="mt-5 text-[1.0625rem] leading-relaxed text-ink-mute">
